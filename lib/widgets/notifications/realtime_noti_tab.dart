...
class RealtimeNoti extends ConsumerWidget {
  const RealtimeNoti({super.key});
  ...
  Widget build(BuildContext context, ref) {
    ...
    var data;
    getData(size) async {
      data = await ref.watch(notificationProvider).getNotificationRealtime(size);
    }

    Future<void> onRefresh() {
      return ref.refresh(notificationProvider).getNotificationRealtime(size);
    }
